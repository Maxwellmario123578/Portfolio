...
export class PortfolioDataService {
    ...
    return of([
      {
        ...
        imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC0Na9rS2sUnmMCbWNycGCxdWoc83kIajvDT_P6Xd768cmiGAB3jAFYmb6HT7wCDNUtzOd6TeBvV7WfVUKWm0wwn4XNIv557HWXVJfptUDif-f5GutnvCGBszfgCotI37UANH4nW5E6skGf6fiocqFtyi3NRUuyn7z1S8PJhE3q-6BgUHK4LZ4byC0QYM7EJ2WEgzcmlHCReUXNErdCrG3bcg9nlpFJR6kJkn4EOXvQMAeF8AMFBmKe7zipfP1PT0h2WnHK9c9guXiB',
        technologies: ['Charts.js', 'HTML/CSS', 'Tailwindcss','JavaScript'],
        fullDescription: 'A comprehensive analytics platform that provides real-time insights into sales performance. Built with modern web technologies and powered by advanced data processing algorithms.',
        features: [
      ...
      },
      {
        ...
        imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuClwx3WQum2T0mlBYXTZ5gN9yXiC-FmSNrpeKNdMgLjbsKMHPX5QY3Z5mR5npuTFjWosgh9R2o4ihzyUt-mq5WB32r8wjjKHkF8yCIZ2WYNc0Zwsiau-sldyDPYflkfFKYoPpwCCel9VsC1ItzRfZt1Qvm52ShgZIDAD0_d4a2s2f5P_W6HfZ-oyfF2ADmesJ4vtZlBFa3HS4-BoV37r8W3dhO6TQ9ozAP4Uigh5BotXITig_7V7H1NcMYCkeQNUzVxqSShcnX5co_5',
        technologies: ['Scikit-learn', 'Numpy', 'Pandas','Python'],
        fullDescription: 'An advanced NLP system that processes text data to extract sentiment, emotions, and key insights. Trained on millions of data points for high accuracy.',
        features: [
      ...
      },
      {
        ...
        imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDEzNp6gF5Q4ucf9Pb1Ss1e9YtRL_sK_OZ2qhj7wBpt6K0SC2akcsVl8U09l77wagHjoo5MqNKkxzOIyeXq77G_jrk2OIGDUz3j9fzV3Xprxn7fQMCo-EOERnDi-ovn9mBLzRs6Afy8qe-BPBCI4YTHKGeKYURwjs_61XfhI_LD951hBZlCXEOcR074GO-c9o6KGYJtLvq4Q_Gp9qxdGioimWKV6J-CrEMCED11dhusrMpjTb7ItJJP0PvDf2HJT5OFCzDNp1j-TLk9',
      ...
      },
      {
        ...
        description: 'Projet en cours de réflexion visant à développer un système de détection automatisée des déchets à l\'aide de techniques de Deep Learning. L\'idée est encore en phase de conceptualisation et de modélisation.',
        imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC0Na9rS2sUnmMCbWNycGCxdWoc83kIajvDT_P6Xd768cmiGAB3jAFYmb6HT7wCDNUtzOd6TeBvV7WfVUKWm0wwn4XNIv557HWXVJfptUDif-f5GutnvCGBszfgCotI37UANH4nW5E6skGf6fiocqFtyi3NRUuyn7z1S8PJhE3q-6BgUHK4LZ4byC0QYM7EJ2WEgzcmlHCReUXNErdCrG3bcg9nlpFJR6kJkn4EOXvQMAeF8AMFBmKe7zipfP1PT0h2WnHK9c9guXiB',
        technologies: ['En cours de définition : recherche sur les frameworks Deep Learning adaptés'],
        fullDescription: 'Projet exploratoire visant à concevoir un système intelligent capable de détecter et classer automatiquement les déchets dans différents environnements à l\'aide du Deep Learning. Le projet est actuellement en phase de réflexion et de modélisation, où l\'équipe analyse les besoins, les types de données à collecter et les approches techniques possibles. L\'objectif futur est de développer une solution pratique et évolutive pour la surveillance environnementale et le nettoyage automatique.',
        features: [
  ...
  getTimeline(): Observable<TimelineItem[]> {
    return of([
      {
        id: '1',
        title: 'Étudiant en Ingénierie Logiciel et Data Science',
    ...
    return of([
      {
        ...
        issuer: 'IBM',
        date: 'Certifié',
        imageUrl: 'https://s3.amazonaws.com/coursera-course-photos/fb/40e3a0b67611e8a95cbf6c0c5d88a3/IBM-DS-Logo.png',
      ...
      },
      {
        ...
        issuer: 'Google',
        date: 'En cours',
        imageUrl: 'https://s3.amazonaws.com/coursera-course-photos/1b/03f7b04fc511e8a7b7bb5c9e6b0e1e/Google-DA-Logo.png',
